...
public interface GameEngineCallback
{
   ...
   /**
    * 
    * called when the player has bust with final result 
    * (score prior to the last card that caused the bust)
    * 
    * @param player
    *            the current Player
    * @param result
   ...
   /**
    * called when the HOUSE has bust with final result 
    * (prior to the last card that caused the bust)
    * 
    * @param result
